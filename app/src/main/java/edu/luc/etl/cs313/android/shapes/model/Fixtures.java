...
public class Fixtures {
  ...
  public static final Shape ClassDiagramTask = new Group(
    new Location(100, 80,new StrokeColor(Color.BLUE, new Rectangle(100, 50))),
    new Group(
      new Location(400, 100, new Circle(50)),
      new Location(400, 100, new Circle(40)),
      new Location(400, 100,new StrokeColor(Color.RED,new Fill(new Circle(20))))
    )
  );
